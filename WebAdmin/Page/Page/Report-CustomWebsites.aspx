<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Main-Menu.master" AutoEventWireup="true" CodeBehind="Report-CustomWebsites.aspx.cs" Inherits="WebAdmin.Page.Page.Report_CustomWebsites" %>
        ...
        <Columns>
            <asp:TemplateField ItemStyle-Width="18px">
                ...
                <ItemTemplate>
                    ...
                    <asp:Label ID="lblID" runat="server" Text='<%# Bind("Url") %>' Visible="False"></asp:Label>
                </ItemTemplate>
                <ItemStyle HorizontalAlign="Center" />
            </asp:TemplateField>
            
            <asp:BoundField DataField="Url" HeaderText="Url" SortExpression="Url" HtmlEncode="false" />
            <asp:BoundField DataField="TimesUsed" HeaderText="Times Used" SortExpression="TimesUsed" HtmlEncode="false" />
