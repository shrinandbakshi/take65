...
{
    public partial class Non_registeredUsers : System.Web.UI.Page
    {
        ...
        private void LoadPostBack()
        {
            if (!IsPostBack)
            {
                ...
                lblSubTitle.Text = "User Not Yet Signed Up";
        ...
        private void LoadData()
        {
            ...
            List<Model.User> lUsers = bllUser.GetAllNonRegisteredUsers();
            //if (lUsers != null)
            //{
