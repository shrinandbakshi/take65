<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Main-Menu.master" AutoEventWireup="true" CodeBehind="TrustedSourcesWebsites.aspx.cs" Inherits="WebAdmin.Page.Page.TrustedSourcesWebsites" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentPage" runat="server">
    ...
    <asp:GridView CssClass="table" ID="gdvAdmin" runat="server" AutoGenerateColumns="False"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="CurrentTag.Display" HeaderText="Category" SortExpression="Tag" HtmlEncode="false" />
