<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Main-Menu.master" AutoEventWireup="true" CodeBehind="Report-Users.aspx.cs" Inherits="WebAdmin.Page.Page.Report_Users" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentPage" runat="server">
    ...
    <asp:GridView CssClass="table" ID="gdvAdmin" runat="server" AutoGenerateColumns="False"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="FacebookId" HeaderText="FacebookId" SortExpression="FacebookId" HtmlEncode="false" />
            <asp:BoundField DataField="register" HeaderText="Register Date" SortExpression="register" HtmlEncode="false" />
        </Columns>
    </asp:GridView>
</asp:Content>
